...
const SCENES = [
  ...
  { eyebrow: 'Golden hour', title: 'Elder Company', hook: 'An unhurried afternoon. A patient ear. Warm, familiar company.', photo: { src: 'https://images.unsplash.com/photo-1454875392665-2ac2c85e8d3e?w=1200&q=80', alt: 'Elderly person sitting with hands gently folded in their lap' }, chips: ['Park benches', 'Old stories', 'Evening walks'], dark: false },
];
